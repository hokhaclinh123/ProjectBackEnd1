...
$searchProductList = $productModel->searchProduct($keyword);
...
<body>
    ...
    <header class="top_header">
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            ...
            <div class="login">
                <a href="login.php" class="btn btn-primary">Login <i class="fas fa-sign-in-alt"></i></a>
            </div>
        </nav>
    </header>
    ...
    <div class="container">
        <div class="product-items">
            <div class="row">
                <?php
                foreach ($searchProductList as $item) {
                    ...
                    <div class="col-md-4 col-12 mb-lg-5 mb-4">
                        <div class="product-item">
                            ...
                            <!--   <p class="desc">
                                <?php echo substr($item['product_description'], 0, 50); ?>
                                <a href="/<?php echo BASE_URL; ?>/product.php/<?php echo $pName . '-' . $item['product_id']; ?> ">
                                    <?php echo "[...]"; ?> </a>
                                </p> -->
